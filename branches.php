                            ...
                            <div class="table-responsive">
                                <table class="table table-hover e-commerce-table">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "SELECT idkunde,kundennummer,strasse,anrede,vorname,nachname,nr,plz,ort,ortauswahl,naechstepruefung 
                                        FROM `kundenadressen` k JOIN `user_logins` u ON k.idkunde=u.company_id WHERE u.user_id='$sesssion_uid' ";
                                        //echo $sql;
                                        $conn = $GLOBALS['con'];
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    ...
                                                    <!-- <a data-toggle="tooltip" data-placement="top" title="Kunden löschen"
                                                        ...
                                                        href="control/branches_process.php?key=<?php echo $row['idkunde']; ?>&action=delete"
